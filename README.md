## WALMART_Sales_forecast_EDA
Initial Report and Exploratory Data Analysis (EDA) for Capstone Project WALMART_Sales_forecast
...
### Project Structure
project-name/ Walmart_Sales_forecast_EDA
...
Select Features that impacts Weekly  Sales using: feature_importances_ (XGBoost built-in function) is used to identify critical features.
Features like Thanksgiving, Dept, Size, Type, Store and marksdowns have high imprtance in sales prediction.

### Baseline Model using LinearRegressor
Base Model has Normalised RMSE: 134.8
